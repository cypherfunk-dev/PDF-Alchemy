...
def transformar():
    ...
    def show_success_message(message):
        ...
        etiquetasaludo.configure(text="First, choose the file you want \nto work your magic on...")
    ...
    if seleccion == "PDF to Word":
        ...
        def pdf_to_excel(rutapdf, rutaxlsx):
            try:
                tables = tabula.read_pdf(rutapdf, pages='all')
    ...
    selector.configure(fg_color="Grey")
...
etiquetasaludo.pack(padx=50, pady=35)

ocean_img = customtkinter.CTkImage(light_image=Image.open("image.jpg"),size=(500,500))
# Creating label and packing it to the window.
imagenql = customtkinter.CTkLabel(frame_abajo, image=ocean_img, text="")
imagenql.pack(pady=20, padx=20)
